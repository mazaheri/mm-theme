<?php
/**
 * The Coming Soon launch screen.
 * Used as the fallback for any URL without a dedicated template (see
 * page.php, index.php) until page-specific templates are added for them.
 */
